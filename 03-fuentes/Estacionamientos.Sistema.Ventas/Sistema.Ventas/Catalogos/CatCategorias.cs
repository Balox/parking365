...
namespace Sistema.Ventas.Catalogos
{
    public partial class CatCategorias : Form
    {
        ...
        private void CargaGrid()
        {
            ...
            dt = new ClassGenerales().EjecutaQuery("SELECT iCveCategoria as Codigo, cDesc as Categoria, bActivo as Activo FROM Categoria;");
        ...
        private void CargaEdicion()
        {
            if (GridDatos.SelectedCells.Count > 0)
            {
                ...
                DataTable dt = new DataTable();
                dt = new ClassGenerales().EjecutaQuery("SELECT iCveCategoria as Codigo, cDesc as Categoria, bActivo as Activo "+
                    " FROM Categoria where  iCveCategoria=" + iCveUsuarios);
        ...
        private void toolStripButton6_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Inserte una Categoria.", Variables.NombreEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    txtCategoria.Focus();
                    return;
                }
                ...
                {//SELECT iCveCategoria as Codigo, cDesc as Categoria, bActivo as Activo FROM Categoria;
                    ...
                    Inserto = new ClassGenerales().EjecutaQuery2("insert into Categoria  (cDesc, bActivo) values "+
                ...
                else
                {
                    ...
                    Inserto = new ClassGenerales().EjecutaQuery2("update Categoria set cDesc='"+txtCategoria.Text.Trim()+
                        "', bActivo="+Status+" where iCveCategoria=" + iCve);
                }
